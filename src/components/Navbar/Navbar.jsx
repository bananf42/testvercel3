  ...
  return (
    <section className="container pt-6 xl:pt-12">
      <div className="flex items-center justify-between relative">
        ...
        <div
          ref={navlistRef}
          className={`flex xl:items-center gap-4  items-start  xl:gap-12 flex-col xl:flex-row absolute w-full top-16 left-0 xl:relative xl:w-fit xl:top-auto xl:left-auto bg-white xl:bg-transparent p-4 xl:p-0 rounded-3xl xl:rounded-none duration-500 ease-in-out shadow-2xl xl:shadow-none overflow-hidden z-50 ${
            isNavOpen ? `h-[250px]` : `h-0 py-0 xl:h-fit`
          } `}
        >
